...
{ 
  ...
  if (song_number ==1)
  {music.play("Avengertheme.wav",10);} //Play song 1 from 10th second 

  if (song_number ==2)
  {music.play("Dynamite.wav",33);} //Play song 2 from 33rd second 

  if (song_number ==3)
  {music.play("Charliebgm.wav");} //Play song 3 from start

  if (song_number ==4)
  {music.play("shapeofyou.wav",25);} //Play song 4 from 25th second 
